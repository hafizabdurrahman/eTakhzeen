        ...
        <div className="space-y-6">
            ...
            <Reveal delay={60}>
                <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
                    ...
                    <KpiCard label="Cancelled + Returned" value={kpis.lost} icon={TrendingDown} chip="bg-red-50 text-red-600 dark:bg-red-500/10 dark:text-red-400" />
                </div>
            </Reveal>
...
function KpiCard({ label, value, icon: Icon, chip }) {
    return (
        <div className="flex min-h-[92px] flex-col items-center justify-center gap-1.5 rounded-lg border border-stone-200 bg-white p-3.5 text-center shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-stone-800 dark:bg-stone-900">
            ...
            <p className="text-lg font-bold tabular-nums text-stone-900 dark:text-stone-100">{value}</p>
        </div>
    );
}
